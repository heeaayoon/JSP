...
int totalCount = dao.seletCount(param); //dao가 제공하는 selectCount()메서드를 이용해 게시물 수 확인
...
<body>
	...
	<table border="1" width="90%">
		<tr>
			<td align="right"><button type="button" onclick="location.href='Write.jsp';">글쓰기</button></td>
		</tr>
	</table>
</body>
</html>